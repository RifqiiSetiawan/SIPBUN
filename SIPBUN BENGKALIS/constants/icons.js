...
const input=require("../assets/icons/input.png")
const inputoutline=require("../assets/icons/input-outline.png")
const box=require("../assets/icons/box.png")
const boxoutline=require("../assets/icons/box-outline.png")
const logo=require("../assets/images/logo.png")
const picture=require("../assets/icons/pic.png")
const download=require("../assets/icons/Downloadd.png")
